<%@ Page Title="" Language="C#" MasterPageFile="~/admin_master.Master" AutoEventWireup="true" CodeBehind="DelTeacher.aspx.cs" Inherits="mas.DelTeacher" %>
     ...
     <table class="auto-style2">
        ...
        <tr>
            ...
            <td class="w3-right-align" style="width: 407px">
                <asp:Label ID="Label2" runat="server" Text="Enter Teacher ID"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="width: 407px">&nbsp;</td>
            <td>
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Find Teacher" />
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
