<%@ Page Title="" Language="C#" MasterPageFile="~/admin_master.Master" AutoEventWireup="true" CodeBehind="addhod.aspx.cs" Inherits="mas.addhod" %>
 ...
 <table class="auto-style2">
        ...
        <tr>
            ...
            <td class="w3-right-align">
                <asp:Label ID="Label2" runat="server" Text="Enter HOD Name"></asp:Label>
            </td>
    ...
    <table class="auto-style2">
        ...
        <tr>
            ...
            <td class="w3-center">
                <asp:Button ID="Button2" runat="server" BackColor="#33CC33" ForeColor="White" OnClick="Button2_Click1" Text="ADD" Width="95px" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
