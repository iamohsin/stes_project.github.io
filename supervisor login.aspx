<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="supervisor login.aspx.cs" Inherits="mas.supervisor_login" %>
...
<body>
    ...
    <strong>
    <asp:Label ID="Label6" runat="server" style="font-size: xx-large; color: #3399FF; text-decoration: underline; background-color: #FFFFFF" Text="HOD Panel Login"></asp:Label>
    </strong>
