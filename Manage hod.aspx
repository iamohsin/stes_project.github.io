<%@ Page Title="" Language="C#" MasterPageFile="~/admin_master.Master" AutoEventWireup="true" CodeBehind="Manage hod.aspx.cs" Inherits="mas.Manage_hod" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style2">
        ...
        <tr>
            <td class="w3-center">
                <asp:Button ID="Button2" runat="server" BackColor="#00CC00" ForeColor="White" OnClick="Button2_Click" Text="Add New HOD" />
            </td>
            <td class="w3-center">
                <asp:Button ID="Button3" runat="server" BackColor="Red" ForeColor="White" OnClick="Button3_Click" Text="Delete HOD" />
            </td>
        </tr>
    </table>
    <br />
