<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="student login.aspx.cs" Inherits="mas.student_login" %>
...
<body>
    ...
    <strong>
    <asp:Label ID="Label6" runat="server" style="font-size: xx-large; color: #3399FF; text-decoration: underline; background-color: #FFFFFF" Text="Student Panel Login"></asp:Label>
    </strong>
