...
namespace mas
{
    public partial class change_stdpass : System.Web.UI.Page
    {
        int sid;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                da.Fill(ds);
                Label5.Text = ds.Tables[0].Rows[0]["studentid"].ToString();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                connect.Open();
                sql = "SELECT * from student where user='" + Session["User"] + "' and pass = '" + TextBox1.Text + "'";
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection connect = new MySqlConnection(connectstring);
            connect.Open();
            MySqlCommand cmd = new MySqlCommand("UPDATE `student` SET `pass`='"+Convert.ToInt32(TextBox2.Text)+"' WHERE Studentid='"+sid + "'", connect);
